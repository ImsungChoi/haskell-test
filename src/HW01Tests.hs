...
testHanoi (num, a, b, c, m) = hanoi num a b c == m
...
testHanoi2 :: (Integer, Peg, Peg, Peg, Peg, Int) -> Bool
testHanoi2 (num, a, b, c, d, m) = length (hanoi2 num a b c d) == m

ex7Tests :: [Test]
ex7Tests = [ Test "hanoi test" testHanoi2 
              [(15, "a", "b", "c", "d", 129)]
           ]
